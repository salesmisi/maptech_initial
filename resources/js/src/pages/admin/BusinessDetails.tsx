...
import { Building2, ImagePlus, Save, Trash2, CheckCircle, AlertCircle } from 'lucide-react';
...
export function BusinessDetails() {
  ...
  const onSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage({ type: 'error', text: err?.message || 'Failed to save business details.' });
    } finally {
      setSaving(false);
    }
  };
