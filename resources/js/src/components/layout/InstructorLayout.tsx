              ...
              <div className="flex items-center gap-3">
                ...
                {user.profile_picture ? (
                  <img
                    ...
                    alt={user.name}
                    className="h-9 w-9 rounded-full object-cover cursor-pointer hover:ring-2 hover:ring-amber-400 transition flex-shrink-0"
                    onClick={() => setShowPicPreview(true)}
                  />
                ) : (
                  <div className="h-9 w-9 rounded-full bg-amber-500 flex items-center justify-center text-white font-bold flex-shrink-0">
